...
with open('blastp_output_before_dRep_july29.tsv', 'w') as p:
    header = 'Bin_name' + '\t' + 'Binning' + '\t' + 'Assembly' + '\t' + 'Sample_number' + '\t' + 'RpS2_count' + '\t' + 'RpL4_count' + '\t' + 'MIP_count' + '\t' + 'ClcA_count' + '\t' + \
    ...
    for BlastP in glob.glob('/home/mad149/Metagenome_grassmere/Diamond_blastp/*'):
        ...
        Line = Bin_name + '\t' + Binning + '\t' + Assembly + '\t' + Sample_number + '\t' + str(RpS2_count) + '\t' + str(RpL4_count) + '\t' + str(MIP_count) + '\t' + str(ClcA_count) + '\t' + \
