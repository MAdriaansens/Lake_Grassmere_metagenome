...
stats.sh in=Step4_filter_size/2kb/Z37TGN_${array[$SLURM_ARRAY_TASK_ID]}_TrimmomaticJuly7_vanilla_Spades_2Kbsize_filtered_contig.fna 2>&1 > Step5_BBMap/Z37TGN${array[$SLURM_ARRAY_TASK_ID]}_TrimmomaticJuly7_MetaSpades_size_2kfiltered_BBmap_contig.txt
stats.sh in=Step4_filter_size/2kb/Z37TGN_${array[$SLURM_ARRAY_TASK_ID]}_TrimmomaticJuly7_vanilla_Spades_2Kbsize_filtered_contig.fna 2>&1 > Step5_BBMap/Z37TGN${array[$SLURM_ARRAY_TASK_ID]}_TrimmomaticJuly7_MetaSpades_size_2kfiltered_BBmap_contig.txt
